...
use App\Post;
use App\Topic;
use App\Facades\GetMentionedUsers;
...
class PostsController extends Controller 
{
    ...
    public function create (CreatePostFormRequest $request, Topic $topic)
    {
        ...
        $mentioned_users = GetMentionedUsers::getFacadeAccessor($request->post);
    ...
    public function update (UpdatePostFormRequest $request, Topic $topic, Post $post)
    {
        ...
        $mentioned_users = GetMentionedUsers::getFacadeAccessor($request);
